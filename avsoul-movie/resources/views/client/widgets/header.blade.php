            ...
            <div class="col-12">
                <div class="header__content">
                    ...
                    <ul class="header__nav">
                        ...
                        <li class="header__nav-item">
                            <a class="header__nav-link" href="pricing.html">Genres</a>
                        </li>
                        <li class="header__nav-item">
                            <a class="header__nav-link" href="pricing.html">About Us</a>
                        </li>
                        <li class="header__nav-item">
                            <a class="header__nav-link" href="pricing.html">Contact</a>
                        </li>
                        {{-- <li class="header__nav-item">
                    ...
                    <div class="header__actions" style="width: 500px;">
                        ...
                        {{-- <a href="{{route('signin')}}" class="header__user">
                            <span>刘亦菲</span>
                            <img src="{{asset('main/img/avatar.jpg')}}" alt="" class="rounded-circle">
                        </a> --}}

                        @if(Auth::check())
                            <a href="{{ route('auth.profile') }}" class="header__user">
