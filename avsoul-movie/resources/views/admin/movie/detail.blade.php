                            ...
                            <div class="row">
                                <div class="col-12 col-md-5 form__cover">
                                    <div class="row">
                                        <div class="col-12 col-sm-6 col-md-12">
                                            <div class="form__img">
                                                <img src="{{$movie->image?? ''}}" style="height: 100%; width:auto"/>                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-12">
                                    <div class="form__img" style="max-height:300px;">
                                        <img src="{{$movie->images?? ''}}" height=auto" width="100%"/>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        {{$i++}}
                            <tr>
                                ...
                                <td>
                                    ...
                                    <div class=" shortenedText main__table-text">{{$comment->content}}</div>
                                </td>
                                <td>
                    ...
                    <tbody>
                        ...
                        {{$j++}}
                            <tr>
                                ...
                                <td>
                                    <div class="shortenedTextRate main__table-text">{{$rate->content}}</div>
                                </td>
                                <td>
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        var textElements = document.getElementsByClassName('shortenedText');
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        var maxLength = 35; // Số ký tự tối đa bạn muốn hiển thị
        var textElements = document.getElementsByClassName('shortenedTextRate');
        ...
        Array.from(textElements).forEach(function(textElement) {
            ...
            if (text.length > maxLength) {
                var shortenedTextRate = text.slice(0, maxLength) + '...';
                textElement.textContent = shortenedTextRate;
            }
        });
    });
</script>
