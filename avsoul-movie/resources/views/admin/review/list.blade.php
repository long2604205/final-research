        ...
        <table class="main__table">
            ...
            <tbody>
                {{-- <tr>
                    ...
                    <td>
                        <div class="main__table-text main__table-text--rate"><svg xmlns="http://www.w3.org/2000/svg"
                                viewBox="0 0 24 24">
                                <path
                    ...
                    <td>
                        <div class="main__table-btns">
                            <a href="#" class="main__table-btn main__table-btn--banned">
                                <svg style="fill: #eb5757" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                                    <path
                ...
                <tr>
                    ...
                    <td>
                        <div class="shortRateContent main__table-text">{{$rate->content}}</div>
                    </td>
                    <td>
                        <div class="main__table-text main__table-text--rate"><svg xmlns="http://www.w3.org/2000/svg"
                                viewBox="0 0 24 24">
                    ...
                    <td>
                        <div class="main__table-btns">
                            @if ($rate->status == 1)
                            <a href="{{ route('reviews.changeStatus', ['id' => $rate->id, 'status' => 2 ]) }}" class="main__table-btn main__table-btn--banned">
                            ...
                            @else
                            <a href="{{ route('reviews.changeStatus', ['id' => $rate->id, 'status' => 1 ]) }}" class="main__table-btn main__table-btn--banned">
                            ...
                            <a onclick="showCustomRateAlert({{$rate->id}})" class="main__table-btn main__table-btn--delete">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                                    <path
                                        d="M10,18a1,1,0,0,0,1-1V11a1,1,0,0,0-2,0v6A1,1,0,0,0,10,18ZM20,6H16V5a3,3,0,0,0-3-3H11A3,3,0,0,0,8,5V6H4A1,1,0,0,0,4,8H5V19a3,3,0,0,0,3,3h8a3,3,0,0,0,3-3V8h1a1,1,0,0,0,0-2ZM10,5a1,1,0,0,1,1-1h2a1,1,0,0,1,1,1V6H10Zm7,14a1,1,0,0,1-1,1H8a1,1,0,0,1-1-1V8H17Zm-3-1a1,1,0,0,0,1-1V11a1,1,0,0,0-2,0v6A1,1,0,0,0,14,18Z" />
                                </svg>
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        var textElements = document.getElementsByClassName('shortRateContent');
        ...
        Array.from(textElements).forEach(function(textElement) {
            ...
            if (text.length > maxLength) {
                var shortRateContent = text.slice(0, maxLength) + '...';
                textElement.textContent = shortRateContent;
            }
        });
    });
</script>
<script>
    function showCustomRateAlert(Id) {
        // Tạo phần tử overlay và thêm CSS trực tiếp
        var overlay = document.createElement('div');
        overlay.setAttribute('class', 'overlay');
        overlay.style.position = 'fixed';
        ...
        var message = document.createElement('p');
        message.textContent = 'Are you sure to permanently delete this review?';
        message.style.color = 'White';
        message.style.fontSize = '14px';
        toxicAlert.appendChild(message);
        ...
        confirmButton.onclick = function() {
            // Chuyển hướng đến href sau khi xác nhận hành động
            setTimeout(function() {
                window.location.href = "/administrator/reviews/delete-" + Id;;
            }, 500); // Đợi 500 miligiây trước khi chuyển hướng
        };
        toxicAlert.appendChild(confirmButton);
