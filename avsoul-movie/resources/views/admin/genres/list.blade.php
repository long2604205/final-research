                    ...
                    <tr>
                        ...
                        <td>
                            <div class="main__table-btns">
                                @if ($genre->status == 1)
                                    <a href="{{ route('genre.changeStatus', ['id' => $genre->id, 'status' => 2 ]) }}" class="main__table-btn main__table-btn--banned">
                                ...
                                @else
                                <a href="{{ route('genre.changeStatus', ['id' => $genre->id, 'status' => 1 ]) }}" class="main__table-btn main__table-btn--banned">
