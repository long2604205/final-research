...
<div class="home home--title">
    ...
    <div class="home__carousel owl-carousel" id="flixtv-hero">
        ...
        <div class="home__card">
            <a href="{{route('mov.details', ['alias' => $movie->alias, 'id' => $movie->id])}}">
                    ...
                    <div class="section__carousel owl-carousel" id="popular">
                        <div class="card">
                            <a href="details.html" class="card__cover">
                                <img src="{{asset('main/img/tenkino.jpeg')}}" alt="">
                    ...
                    <div class="section__interview owl-carousel" id="flixtv">
                        <div class="interview">
                            <a href="interview.html" class="interview__cover">
                                <img src="{{asset('main/img/interview/1.jpg')}}" alt="">
                                <span>
                                    <svg width="22" height="22" viewBox="0 0 22 22" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path fill-rule="evenodd" clip-rule="evenodd"
                        ...
                        <div class="interview">
                            <a href="interview.html" class="interview__cover">
                                <img src="{{asset('main/img/interview/2.jpg')}}" alt="">
                                <span>
                                    <svg width="22" height="22" viewBox="0 0 22 22" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path fill-rule="evenodd" clip-rule="evenodd"
                        ...
                        <div class="interview">
                            <a href="interview.html" class="interview__cover">
                                <img src="{{asset('main/img/interview/3.jpg')}}" alt="">
                                <span>
                                    <svg width="22" height="22" viewBox="0 0 22 22" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path fill-rule="evenodd" clip-rule="evenodd"
                        ...
                        <div class="interview">
                            <a href="interview.html" class="interview__cover">
                                <img src="{{asset('main/img/interview/4.jpg')}}" alt="">
                                <span>
                                    <svg width="22" height="22" viewBox="0 0 22 22" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path fill-rule="evenodd" clip-rule="evenodd"
                        ...
                        <div class="interview">
                            <a href="interview.html" class="interview__cover">
                                <img src="{{asset('main/img/interview/5.jpg')}}" alt="">
                                <span>
                                    <svg width="22" height="22" viewBox="0 0 22 22" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path fill-rule="evenodd" clip-rule="evenodd"
                        ...
                        <div class="interview">
                            <a href="interview.html" class="interview__cover">
                                <img src="{{asset('main/img/interview/6.jpg')}}" alt="">
                                <span>
                                    <svg width="22" height="22" viewBox="0 0 22 22" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path fill-rule="evenodd" clip-rule="evenodd"
